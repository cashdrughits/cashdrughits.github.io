...
toggle.addEventListener('change', () => {
    ...
    if (toggle.checked) {
        ...
        advantages.classList.replace('bg-gray-900/50', 'bg-gray-50');
        partners.classList.replace('bg-gray-900/50', 'bg-gray-50');
        ...
        // Секции преимуществ и партнеров
        advantages.classList.replace('bg-gray-50', 'bg-gray-900/50');
        partners.classList.replace('bg-gray-50', 'bg-gray-900/50');
